package com.example.customrecycle.leanback.recycle;
...
import com.example.customrecycle.leanback.impl.PrvInterface;
...
//        return cannotScrollBackward(value) || cannotScrollForward(value);
    ...
    public void setDefaultItem(int pos) {
        GeneralAdapter.MyViewHolder holder = (GeneralAdapter.MyViewHolder) findViewHolderForAdapterPosition(pos);
