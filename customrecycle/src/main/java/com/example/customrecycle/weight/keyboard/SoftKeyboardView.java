package com.example.customrecycle.weight.keyboard;
...
public class SoftKeyboardView extends View {
	...
	private void setMoveSoftKeyAnimation(SoftKey oldSoftkey, SoftKey targetSoftKey) {
		@SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesXHolder = PropertyValuesHolder.ofFloat("Left", oldSoftkey.getLeft(), targetSoftKey.getLeft());
		@SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesX1Holder = PropertyValuesHolder.ofFloat("Right", oldSoftkey.getRight(), targetSoftKey.getRight());
		@SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesYHolder = PropertyValuesHolder.ofFloat("Top", oldSoftkey.getTop(), targetSoftKey.getTop());
		@SuppressLint("ObjectAnimatorBinding") PropertyValuesHolder valuesY1Holder = PropertyValuesHolder.ofFloat("Bottom", oldSoftkey.getBottom(), targetSoftKey.getBottom());
		//
